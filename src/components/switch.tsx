...
export default function Switch({
  ...
  return (
    ...
    >
      <span className="group-data-[selected]:bg-green-500 group-data-[focus-visible]:ring-2 mr-4 h-6 w-9 cursor-pointer rounded-full border-2 border-transparent bg-zinc-500 ring-offset-2 ring-offset-zinc-900 transition duration-200">
